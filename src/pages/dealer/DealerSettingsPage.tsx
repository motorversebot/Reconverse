  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Your account preferences</p>
      </div>
      ...
      <Card className="glass-panel border-border">
        ...
        <CardContent className="space-y-4 pt-4">
          ...
          <div className="flex justify-end">
            <Button variant="hero" size="sm" onClick={handleSave} disabled={profileLoading} className="gap-2">
